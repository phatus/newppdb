        ...
        <div className="p-6 w-full max-w-[1200px] mx-auto flex flex-col gap-6">
            ...
            <div className="bg-white p-12 rounded-xl border border-slate-200 shadow-sm print:shadow-none print:border-none print:p-0 min-h-[1000px] print:min-h-0 relative">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-sm mt-1">Nomor: _____/PPDB/SDIT-IK/{new Date().getFullYear()}</p>
                </div>

                {/* Isi */}
                <div className="text-justify mb-6 leading-relaxed">
                    <p className="mb-4">
                        Pada hari ini <strong>{dateStr}</strong>, bertempat di {settings?.schoolName || "SDIT Insan Kamil Karanganyar"}, Panitia PPDB telah melaksanakan rapat pleno penetapan hasil seleksi calon peserta didik baru Tahun Pelajaran {settings?.academicYear || "2024/2025"}.
                    </p>
                    <p>
