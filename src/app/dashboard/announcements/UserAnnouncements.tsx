...
export default function UserAnnouncements({ announcements }: { announcements: Announcement[] }) {
                    ...
                    announcements.map((item) => (
                        ...
                        >
                            <div className="flex items-start gap-4">
                                <div className={`p-2.5 rounded-full shrink-0 hidden sm:flex ${item.type === 'IMPORTANT' ? 'bg-red-50 text-red-600 dark:bg-red-900/20 dark:text-red-400' :
                                ...
                                <div className="flex-1 space-y-2">
                                    ...
                                    {item.image && (
                                        <div
                                            className="mt-4 rounded-xl overflow-hidden border border-slate-100 dark:border-slate-800 shadow-sm cursor-pointer max-w-2xl"
