...
export const sendVerificationEmail = async (email: string, token: string) => {
    ...
    const mailOptions = {
        from: `"SPMB Online" <${process.env.SMTP_USER}>`,
        to: email,
        subject: "Verifikasi Email Pendaftaran SPMB",
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 10px;">
                ...
                <p style="color: #475569; font-size: 16px;">Terima kasih telah mendaftar di SPMB Online MTsN 1 Pacitan. Silakan klik tombol di bawah ini untuk memverifikasi alamat email Anda dan mengaktifkan akun Anda.</p>
...
export const sendPasswordResetEmail = async (email: string, token: string) => {
    ...
    const mailOptions = {
        from: `"SPMB Online MTsN 1 Pacitan" <${process.env.SMTP_USER}>`,
        to: email,
        subject: "Reset Password Akun SPMB Online",
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 10px;">
                <h2 style="color: #0f172a; text-align: center;">Reset Password Anda</h2>
                <p style="color: #475569; font-size: 16px;">Halo,</p>
                <p style="color: #475569; font-size: 16px;">Anda telah meminta untuk mereset password akun SPMB Online Anda. Silakan klik tombol di bawah ini untuk mengatur password baru.</p>
                <div style="text-align: center; margin: 30px 0;">
                ...
                <hr style="border: 0; border-top: 1px solid #e2e8f0; margin: 20px 0;" />
                <p style="color: #94a3b8; font-size: 12px; text-align: center;">Tim IT SPMB Online</p>
            </div>
        `,
    };
